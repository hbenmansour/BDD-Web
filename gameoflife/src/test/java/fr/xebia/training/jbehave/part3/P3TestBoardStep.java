...
public class P3TestBoardStep {
	...
	public void givenInitialPositionTable(ExamplesTable table) {
		// FIXME : insérer les initial states en bouclant sur la table d'example
	...
	// FIXME : annoter la méthode avec @Then
	// FIXME : annoter la méthode avec @Alias pour faire marcher toute les stories
	...
	// FIXME : annoter la méthode avec @BeforeStory et réinitialiser le initial state
