...
public class P2TestBoard extends JUnitStories {
	...
	public Configuration configuration() {
        return new MostUsefulConfiguration()
        	...
        	// FIXME : Changer le story loader pour utiliser LoadFromRelativeFile loader (penser à utiliser la classe utilitaire CodeLocations )
	...
	protected List<String> storyPaths() {
    	// FIXME : retourner la liste des stories présentes dans src/test/resources/part2
